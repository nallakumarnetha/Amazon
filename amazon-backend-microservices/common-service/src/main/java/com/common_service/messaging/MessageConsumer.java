package com.common_service.messaging;
...
public class MessageConsumer {
	...
	// we can create separate consumer classes for better organization like CartMessageConsumer, UserMessageConsumer,....

	// consumes messages from the cartQueue queue
	@RabbitListener(queues = "cartQueue")	
	public void consumeCartMessage(CartDTO cartDTO) {
		log.info("message received from rabbitmq: {}", "cartQueue");
		// use cartDTO in this service
	}
